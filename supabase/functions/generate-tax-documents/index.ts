...
serve(async (request) => {
  try {
    ...
    const { customerId, filingId, extraFacts, attachmentName = "", attachmentText = "", dataProcessingConsent } = await request.json();
