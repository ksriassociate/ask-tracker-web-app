    ...
    <div className="p-6 bg-slate-950 text-slate-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-slate-900 p-5 rounded-xl">
          ...
          <p className="text-[11px] leading-relaxed text-slate-500 mt-2">For scanned PDFs, ProAxis processes only the first 50 pages using browser-based OCR. For images, the selected image is processed locally. Files are not uploaded or stored. Review extracted text before generating a draft.</p>
